...
>
    <div class="bg-white rounded-lg shadow-lg p-6 w-11/12 max-w-lg">
        ...
        <form wire:loading.remove>
            <!-- Name -->
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1" for="updateName">Name</label>
                <input type="text" id="updateName" x-bind:value="items.updateName"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="slug" name="slug" x-bind:value="items.updateSlug"
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    required>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="mt-4">
                    <img id="imageUpdatePreview" src="{{ $modalDetails->image ?? '' }}" alt=""
